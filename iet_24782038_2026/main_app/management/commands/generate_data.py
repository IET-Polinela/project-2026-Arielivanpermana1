...
class Command(BaseCommand):
    help = 'Generate fake reports for Lab Session 7'

    def add_arguments(self, parser):
        parser.add_argument('num_records', type=int, help='Jumlah data laporan')
    ...
    def handle(self, *args, **kwargs):
        ...
        context_data = {
            'Jalan Rusak': {
                'titles': [
                    ...
                    'Jalan Ambles di Dekat Drainase'
                ],
            ...
            'Lampu Mati': {
                ...
                'desc': 'Lampu jalan di area ini mati total sehingga membahayakan pengguna jalan.'
            },
            'Drainase': {
                'titles': [
                    'Saluran Air Mampet',
                ...
                'desc': 'Saluran air tersumbat sehingga air meluap ketika hujan turun.'
            },
            'Keamanan': {
                'titles': [
                ...
                'desc': 'Dibutuhkan patroli tambahan karena terdapat aktivitas mencurigakan pada malam hari.'
            }
        }
        ...
        self.stdout.write(
            self.style.SUCCESS(f'Berhasil membuat {num_records} laporan dummy!')
        )